...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/15 22:19:21 by jbach             #+#    #+#             */
/*   Updated: 2022/03/20 16:17:45 by jbach            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../so_long.h"

void	ft_move_up_cosmetible(t_map *map, int p_line, int p_col)
{
	char	*nb_move;
...
void	ft_move_up_notwall(t_map *map, int p_line, int p_col)
{
	...
	if (map->map_tab[p_line - 1][p_col] == 'C')
		ft_move_up_cosmetible(map, p_line, p_col);
