...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/15 22:19:07 by jbach             #+#    #+#             */
/*   Updated: 2022/03/20 16:21:59 by jbach            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../so_long.h"

void	ft_move_left_cosmetible(t_map *map, int p_line, int p_col)
{
	char	*nb_move;
...
void	ft_move_left_notwall(t_map *map, int p_line, int p_col)
{
	...
	if (map->map_tab[p_line][p_col - 1] == 'C')
		ft_move_left_cosmetible(map, p_line, p_col);
